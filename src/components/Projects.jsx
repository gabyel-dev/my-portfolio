          ...
          <div className="proj-1 bg-[#fffffa] shadow-md rounded-2xl min-w-[500px] min-h-[300px] p-10 flex gap-10">
            <div className="left-section w-[40%] flex flex-col gap-3">
              ...
              <p className="karla text-[0.9em]">
                ...
                organize and track their daily activities efficiently. Users can
                view tasks categorized as "Today" and "Completed", search for
                specific tasks. Taskly also includes a secure authentication
                system. Built with React and Flask with PostgreSQL.
              </p>
              <div className="pt-10">
                <p className=" font-bold karla">Technologies Used:</p>
                <ul className="flex">
